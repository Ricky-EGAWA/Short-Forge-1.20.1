...
public class NetherPortalTexturedMapItem extends MapItem {
    ...
    public ItemStack getDefaultInstance() {
        ...
        stack.getOrCreateTag().putBoolean("NetherPortalTextured", true);
        return stack;
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            itemStack.getOrCreateTag().putBoolean("NetherPortalTextured", true);
