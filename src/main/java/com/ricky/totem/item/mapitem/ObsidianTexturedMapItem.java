...
public class ObsidianTexturedMapItem extends MapItem {
    ...
    public ItemStack getDefaultInstance() {
        ...
        stack.getOrCreateTag().putBoolean("ObsidianTextured", true);
        return stack;
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            itemStack.getOrCreateTag().putBoolean("ObsidianTextured", true);
