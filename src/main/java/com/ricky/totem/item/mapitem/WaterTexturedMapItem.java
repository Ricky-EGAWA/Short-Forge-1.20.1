...
public class WaterTexturedMapItem extends MapItem {
    ...
    public ItemStack getDefaultInstance() {
        ...
        stack.getOrCreateTag().putBoolean("WaterTextured", true);
        return stack;
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            itemStack.getOrCreateTag().putBoolean("WaterTextured", true);
