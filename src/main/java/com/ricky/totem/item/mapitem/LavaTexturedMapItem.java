...
public class LavaTexturedMapItem extends MapItem {
    ...
    public ItemStack getDefaultInstance() {
        ...
        stack.getOrCreateTag().putBoolean("LavaTextured", true);
        return stack;
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            itemStack.getOrCreateTag().putBoolean("LavaTextured", true);
